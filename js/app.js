...
function showCreditsSheet() {
  ...
  content.innerHTML = `
    <div style="background:rgba(244,96,12,0.08);border:1px solid rgba(244,96,12,0.2);border-radius:14px;padding:14px 16px;margin-bottom:18px">
      ...
      <div style="font-size:0.78rem;color:var(--muted);line-height:1.6">Songs ka ek hissa complete karo — AI Ustaad aapki performance sunta hai aur feedback deta hai. Kaun sa note weak tha, kaun sa sahi — specific aur helpful.<br><br><strong style="color:var(--saffron)">1 hissa = 1 credit</strong></div>
    </div>
